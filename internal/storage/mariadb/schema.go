...
// Note: MariaDB supports recursive CTEs like MySQL.
// Uses LEFT JOIN instead of NOT EXISTS to avoid potential performance issues.
...
// Uses subquery instead of three-table join for better performance.
